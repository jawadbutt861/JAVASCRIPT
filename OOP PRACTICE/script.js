...
//     }
//     area(){
//         console.log(`Radius = ${3.14 * this.radius*2}`);
//     }
//     circum(){
//         console.log(`Circumference = ${2 * 3.14 * this.radius}`);
//     }
// }

// let area = new Circle(4);
// let circum = new Circle(2);
// area.area();
// circum.circum();
...
// let Salaar = new Movie("Salaar",2024,9)
// Salaar.displayInfo();
